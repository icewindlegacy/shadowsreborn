    ...
    for (iHash = 0; iHash < MAX_KEY_HASH; iHash++)
    {
             ...
             pRoomIndex = pRoomIndex->next)
        {
            if (pRoomIndex->area == pArea)
            {
                ...
                {                /* I hate this! */
                    /* After fix_exits(), all exits should have valid pointers */
...
/*    {
    ...
    if (!str_cmp ("world", arg1))
    {
        ...
        save_classes ();  /* Save skill/class level changes */
        save_clans ();   /* Save clan table changes */
