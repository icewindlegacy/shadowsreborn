...
const struct cmd_type cmd_table[] = {
    ...
    {"cguild",    do_cguild,    POS_SLEEPING, 0,  LOG_NORMAL, 1},
    {"clist",     do_clanlist,  POS_SLEEPING, 0,  LOG_NORMAL, 1},
    {"cleader",   do_cleader,   POS_SLEEPING, L4, LOG_NORMAL, 1},
    {"roster",    do_roster,    POS_SLEEPING, 0,  LOG_NORMAL, 1},
    ...
    {"smoke",     do_smoke,     POS_RESTING,  0,  LOG_NORMAL, 1},
    {"exhale",    do_exhale,    POS_RESTING,  0,  LOG_NORMAL, 1},
    {"chew",      do_chew,      POS_RESTING,  0,  LOG_NORMAL, 1},
    {"spit",      do_spit,      POS_RESTING,  0,  LOG_NORMAL, 1},
    {"light",     do_light,     POS_RESTING,  0,  LOG_NORMAL, 1},
    {"pack",      do_pack,      POS_RESTING,  0,  LOG_NORMAL, 1},
    {"press",     cmd_press,    POS_STANDING, 0,  LOG_NORMAL, 1},
    {"clanlist",      do_clanlist,  POS_SLEEPING, 0,  LOG_NORMAL, 1},
    {"induct",        do_induct,    POS_STANDING, 0,  LOG_NORMAL, 1},
    {"outcast",       do_outcast,   POS_STANDING, 0,  LOG_NORMAL, 1},
    {"petition",      do_petition,  POS_STANDING, 0,  LOG_NORMAL, 1},
     ...
     */
    {"laffects",   do_affects_long,   POS_DEAD,     0, LOG_NORMAL, 1},
...
/*  {"groups",    do_groups,    POS_SLEEPING, 0, LOG_NORMAL, 1}, */
    ...
    {"showclass", do_showclass, POS_DEAD,     0, LOG_NORMAL, 1 }, 
...
/*  { "channels",    do_channels,    POS_DEAD,     0,  LOG_NORMAL, 1 }, */
    ...
    {"second",		do_second,	POS_FIGHTING,	0, LOG_NORMAL, 1},
...
/*  { "auction",    do_auction,    POS_SLEEPING,     0,  LOG_NORMAL, 1 }, */
    ...
    {".", do_comm1, POS_SLEEPING, 0, LOG_NORMAL, 0},
    ...
    {"hint", do_hint, POS_DEAD, 0, LOG_NORMAL, 1},
/*  { "music",        do_music,    POS_SLEEPING,     0,  LOG_NORMAL, 1 }, */
   ...
   // {"quote", do_quote, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"verbeeg", do_verbeeg, POS_RESTING, 0, LOG_NORMAL, 1},
...
/*  { "unlock",        do_unlock,    POS_RESTING,     0,  LOG_NORMAL, 1 }, */
    ...
    {"headbutt", do_headbutt, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"slam", do_slam, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"darkness", do_darkness, POS_STANDING, 0, LOG_NORMAL, 1},
    {"dirt", do_dirt, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"disarm", do_disarm, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"fade", do_fade, POS_STANDING, 0, LOG_NORMAL, 1},
    {"flank", do_flank, POS_STANDING, 0, LOG_NORMAL, 1},
...
/*  { "group",        do_group,    POS_SLEEPING,     0,  LOG_NORMAL, 1 }, */
    ...
    {"bandage", do_bandage, POS_RESTING, 0, LOG_NORMAL, 1},
...
/*  { "practice",    do_practice,    POS_SLEEPING,     0,  LOG_NORMAL, 1 }, */
    ...
    {"regeneration", do_regeneration, POS_RESTING, 0, LOG_NORMAL, 1},
    {"protocol", do_protocol, POS_RESTING, 0, LOG_NORMAL, 1},
    {"protocols", do_protocol, POS_RESTING, 0, LOG_NORMAL, 0},
    {"/", do_recall, POS_FIGHTING, 0, LOG_NORMAL, 0},
    {"/c", do_recall_clan, POS_FIGHTING, 0, LOG_NORMAL, 0},
    ...
    {"stoneform", do_stoneform, POS_STANDING, 0, LOG_NORMAL, 1},
    {"flesh", do_flesh, POS_STANDING, 0, LOG_NORMAL, 1},
    {"split", do_split, POS_RESTING, 0, LOG_NORMAL, 1},
    {"steal", do_steal, POS_STANDING, 0, LOG_NORMAL, 1},
    {"tailwhip", do_tailwhip, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"throwrock", do_throw_rock, POS_FIGHTING, 0, LOG_NORMAL, 1},
    ...
    {"3", do_comm3, POS_RESTING, 0, LOG_NORMAL, 1},
    {"4", do_comm4, POS_RESTING, 0, LOG_NORMAL, 1},
    ...
    {"forget",		do_forget,	POS_DEAD, 0, LOG_NORMAL, 1},
    {"remember",	do_remember,	POS_DEAD, 0, LOG_NORMAL, 1},
    ...
    {"wpeace",		do_wpeace,	POS_DEAD, L5, LOG_NORMAL, 1},
    ...
    {"auction",		do_auction,	POS_RESTING, 0, LOG_NORMAL, 1},
    {"copyover",	do_copyover,	POS_DEAD, ML, LOG_ALWAYS, 1},
    {"memdump",		do_dump,	POS_DEAD, ML, LOG_ALWAYS, 0},
    {"traplist",	do_traplist,	POS_DEAD, L4, LOG_NORMAL, 1},
    {"trapstat",	do_trapstat,	POS_DEAD, L4, LOG_NORMAL, 1},
    {"trapset",		do_trapset,	POS_DEAD, L4, LOG_NORMAL, 1},
    {"trapremove",	do_trapremove,	POS_DEAD, L4, LOG_NORMAL, 1},
...
/*  { "goto",        do_goto,    POS_DEAD,    L8,  LOG_NORMAL, 1 }, */
    ...
    {"jail",		do_jail,	POS_DEAD, L5, LOG_NORMAL, 1},
    ...
    {"skilledit", do_skedit, POS_DEAD, 0, LOG_NORMAL, 1},
    {"cedit", do_cedit, POS_DEAD, 0, LOG_NORMAL, 1},
    {"clanedit", do_cedit, POS_DEAD, 0, LOG_NORMAL, 1},
    ...
    {"exlist", do_exlist, POS_DEAD, L4, LOG_NORMAL, 1},
    ...
    {"dump", do_cdump, POS_RESTING, 0, LOG_NORMAL, 1},
    {"noexp", do_noexp, POS_DEAD, 0, LOG_NORMAL, 1},
    {"engage", do_engage, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"wflag", do_wflag, POS_DEAD, L4, LOG_ALWAYS, 1},
    {"ftick", do_ftick, POS_DEAD, ML, LOG_NORMAL, 1},
    {"scrape",    do_scrape,    POS_RESTING,  0,  LOG_NORMAL, 1},
    {"gather",    do_gather,    POS_RESTING,  0,  LOG_NORMAL, 1},
    {"campfire",  do_campfire,  POS_RESTING,  0,  LOG_NORMAL, 1},
    {"arealinks", do_arealinks, POS_DEAD,      ML, LOG_NORMAL, 1},
    {"fish", do_fish, POS_STANDING, 0, LOG_NORMAL, 1},
    {"bounty", do_bounty, POS_STANDING, 0, LOG_NORMAL, 1},
    {"butcher", do_butcher, POS_STANDING, 0, LOG_NORMAL, 1},
    {"cook", do_cook, POS_STANDING, 0, LOG_NORMAL, 1},
    /*
     * End of list.
     */
