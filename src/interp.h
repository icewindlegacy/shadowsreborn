...
DECLARE_DO_FUN( do_comm1        );
DECLARE_DO_FUN( do_comm2        );
DECLARE_DO_FUN( do_comm3        );
DECLARE_DO_FUN( do_comm4        );
...
DECLARE_DO_FUN( do_affects_long		);
DECLARE_DO_FUN( do_cdump		);
