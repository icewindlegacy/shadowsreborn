 ...
 *           starmap.c - November 13, 2025
 */
/***************************************************************************
 * Starmap - by Nebseni of Clandestine MUD.
 * Ported to ROM by Desden, el Chaman Tibetano
 * 
...
void look_sky ( CHAR_DATA * ch )
{
   ...
   if (weather_info[ch->in_room->sector_type].sky > SKY_CLOUDLESS)
   {
