...
DECLARE_OLC_FUN( skedit_mage		);
DECLARE_OLC_FUN( skedit_cleric		);
DECLARE_OLC_FUN( skedit_thief		);
DECLARE_OLC_FUN( skedit_warrior		);
DECLARE_OLC_FUN( skedit_sorcerer	);
DECLARE_OLC_FUN( skedit_shaman		);
DECLARE_OLC_FUN( skedit_knave		);
DECLARE_OLC_FUN( skedit_berserker	);
...
#define EDIT_SKILL(Ch, Sn)	( Sn = (int)(long)Ch->desc->pEdit )
#define EDIT_CLAN(Ch, Cn)	( Cn = (int)(long)Ch->desc->pEdit )
