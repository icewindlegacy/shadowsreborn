...
/*
 * Bool type for newer code compatibility
 */
#if !defined(bool)
#define bool bool_t
#endif
...
typedef struct    info_type        INFO_TYPE;
...
/* Commstone system limits */
#define COMMSTONE_MAX_CHANNELS 4
#define COMMSTONE_MAX_FREQUENCY 99999
...
/*
 * Directory and file defines for new features
 */
#define CLASS_DIR           "../classes/"
#define CLAN_DIR            "../clans/"
#define STORAGE_DIR         "../storage/"  /* Clan storeroom persistent storage */
...
struct    shop_data
{
    ...
    char *       open_msg;              /* Message when shop opens    */
    char *       close_msg;             /* Message when shop closes    */
};
...
#define ACT_MOUNT          (E)   /* Can be mounted     */
...
#define AFF_SLOW        (dd)
#define AFF_WEARINESS   (ee)
*/
#define AFF_BLIND        	(1)     /* race_table aff value: 2 */
#define AFF_INVISIBLE       (2)     /* race_table aff value: 4 */
#define AFF_DETECT_EVIL    (3)     /* race_table aff value: 8 */
#define AFF_DETECT_INVIS   (4)     /* race_table aff value: 16 */
#define AFF_DETECT_MAGIC  (5)     /* race_table aff value: 32 */
#define AFF_DETECT_HIDDEN (6)     /* race_table aff value: 64 */
#define AFF_DETECT_GOOD   (7)     /* race_table aff value: 128 */
#define AFF_SANCTUARY     (8)     /* race_table aff value: 256 */
#define AFF_FAERIE_FIRE    (9)     /* race_table aff value: 512 */
#define AFF_INFRARED       (10)    /* race_table aff value: 1024 */
#define AFF_CURSE        (11)    /* race_table aff value: 2048 */
#define AFF_UNUSED_FLAG        (12)    /* race_table aff value: 4096 (unused) */
#define AFF_POISON        (13)    /* race_table aff value: 8192 */
#define AFF_PROTECT_EVIL    (14)    /* race_table aff value: 16384 */
#define AFF_PROTECT_GOOD    (15)    /* race_table aff value: 32768 */
#define AFF_SNEAK        (16)    /* race_table aff value: 65536 */
#define AFF_HIDE        (17)    /* race_table aff value: 131072 */
#define AFF_SLEEP        (18)    /* race_table aff value: 262144 */
#define AFF_CHARM        (19)    /* race_table aff value: 524288 */
#define AFF_FLYING        (20)    /* race_table aff value: 1048576 */
#define AFF_PASS_DOOR        (21)    /* race_table aff value: 2097152 */
#define AFF_HASTE        (22)    /* race_table aff value: 4194304 */
#define AFF_CALM        (23)    /* race_table aff value: 8388608 */
#define AFF_PLAGUE        (24)    /* race_table aff value: 16777216 */
#define AFF_WEAKEN        (25)    /* race_table aff value: 33554432 */
#define AFF_DARK_VISION        (26)    /* race_table aff value: 67108864 */
#define AFF_BERSERK        (27)    /* race_table aff value: 134217728 */
#define AFF_SWIM        (28)    /* race_table aff value: 268435456 */
#define AFF_REGENERATION        (29)    /* race_table aff value: 536870912 */
#define AFF_SLOW        (30)    /* race_table aff value: 1073741824 */
#define AFF_WEARINESS   (31)    /* race_table aff value: 2147483648 */

/* Tobacco flags */
#define TABAC_SMOKING   (A)
#define TABAC_CHEWING   (B)
...
#define OBJ_VNUM_ORC_SWORD      402
#define OBJ_VNUM_ORC_SPEAR      403
...
#define OBJ_VNUM_CAMPFIRE              7
#define OBJ_VNUM_FISH                  9
...
#define ITEM_KEY         18
#define ITEM_PIPE_TABAC  19
#define ITEM_CHEW_TABAC  20
#define ITEM_TOBACCO     21
#define ITEM_TINDERBOX   22
#define ITEM_FOOD        23
#define ITEM_MONEY       24
#define ITEM_BOAT        25
#define ITEM_CORPSE_NPC  26
#define ITEM_CORPSE_PC   27
#define ITEM_FOUNTAIN    28
#define ITEM_PILL        29
#define ITEM_PROTECT     30
#define ITEM_MAP         31
#define ITEM_PORTAL      32
#define ITEM_WARP_STONE  33
#define ITEM_ROOM_KEY    34
#define ITEM_GEM         35
#define ITEM_JEWELRY     36
#define ITEM_JUKEBOX     37
#define ITEM_WINDOW      38
#define ITEM_GUN         39
#define ITEM_AMMO        40
#define ITEM_BAIT        41
#define ITEM_FISHING_POLE 42
...
#define GUN_SHELL         (H)
#define GUN_ROCKET        (I)
#define GUN_RECOIL_LITTLE (O)
#define GUN_RECOIL_NORMAL (P)
#define GUN_RECOIL_HARD   (Q)
#define GUN_RECOIL_SEVERE (R)
...
#define ROOM_VNUM_GODROOM  2400
#define ROOM_VNUM_UNDERWATER 3
/* ORC FACTION DEFINES */
#define ROOM_VNUM_ORCISH_TEMPLE  400
#define ROOM_VNUM_ORCISH_ALTAR   401
#define ROOM_VNUM_ORCISH_SCHOOL  402
#define ROOM_VNUM_ORCISH_MORGUE  403
/* ARENA DEFINES */
#define ROOM_VNUM_ARENA_START 2500
...
#define ROOM_CLANSTOREROOM     (V)
#define ROOM_ARENA        (W)
#define ROOM_MALEDICTION  (X)  /* Magical darkness - only drow can see */
...
#define PLR_NOEXP        (bb)
#define PLR_QUESTING      (cc) /* Questing flag */
#define PLR_AUTOTICK      (dd)
...
struct    char_data
{
    ...
    int	pkill;
    int	pdeath;
    int	pkattempt;  /* PK attempts (attacks initiated) */
    int	mkill;
    int	mdeath;
    ...
    long               wiznet;
    long               info; /* wiz stuff */
    long               tabac_flags; /* tobacco flags */
    long               imm_flags;
    long               res_flags;
    long               vuln_flags;
    sh_int             invis_level;
...
struct    pc_data
{
    ...
    sh_int			points;
    sh_int			leader;
    sh_int			petitioning;  /* Clan being petitioned to join */
    bool			confirm_delete;
    ...
    int				room_text[3];           /* {S */   
    int				room_exits[3];
    char *			email;                  /* Email address for finger */
    char *			real_name;              /* Real name for finger */
    char *			forget[MAX_FORGET];     /* Forget list */
    int				questpoints;            /* Quest points */          /* {o */
    sh_int			quest_curr;             /* Current QPoints */
    int				quest_accum;            /* Total QPoints */
    CHAR_DATA *		questgiver;             /* Questing */
    int				nextquest;              /* Time til next quest */
    int				countdown;              /* Time for current quest */
    int				questobj;               /* Quest Object */
    int				questmob;               /* Quest Mob */
    char *			questshort;             /* Short Desc of restrung quest obj */
    int				room_things[3];         /* {O */
    int				prompt[3];              /* {p */
    int				fight_death[3];         /* {1 */
    int				fight_yhit[3];          /* {2 */
    ...
    int				share_level;            /* Level when shares bought */
...
#define PULSE_HINT                (30 * PULSE_PER_SECOND) /* 30 seconds */
...
void     save_pit            args( ( OBJ_DATA *pit ) );
void     save_all_pits       args( ( void ) );
...
//void fwrite_obj args((CHAR_DATA *ch, OBJ_DATA *obj, FILE *fp, int iNest, bool recurse_next));
void fwrite_obj_compat args((CHAR_DATA *ch, OBJ_DATA *obj, FILE *fp, int iNest));
void fwrite_obj args((CHAR_DATA *ch, OBJ_DATA *obj, FILE *fp, int iNest, bool recurse_next));
void     fwrite_obj_ground   args( (OBJ_DATA *obj, FILE *fp, int iNest) );
void     fread_obj           args( ( CHAR_DATA *ch, FILE *fp ) );
void	qmconfig_read		args( ( void ) );

/* macro for fwrite_obj*/
...
bool    damage        args( ( CHAR_DATA *ch, CHAR_DATA *victim, int dam,
                    int dt, int class, bool show, bool critical ) );
...
int     get_obj_max_condition args( ( const OBJ_DATA *obj ) );
void    damage_item_condition args( ( OBJ_DATA *obj, int amount, CHAR_DATA *owner ) );
...
int     count_room_lights args( ( ROOM_INDEX_DATA *pRoomIndex ) );
...
char *    gun_bit_name       args( ( int gun_flags ) );
...
void    do_skill              args( ( CHAR_DATA *ch, char *argument ) );
...
/* act_racial.c */
void    do_dust               args( ( CHAR_DATA *ch, char *argument ) );
void    do_headbutt           args( ( CHAR_DATA *ch, char *argument ) );
void    do_slam               args( ( CHAR_DATA *ch, char *argument ) );
void    do_protocol           args( ( CHAR_DATA *ch, char *argument ) );
void    do_throw_rock         args( ( CHAR_DATA *ch, char *argument ) );
void    do_charge             args( ( CHAR_DATA *ch, char *argument ) );
void    do_stoneform          args( ( CHAR_DATA *ch, char *argument ) );
void    do_flesh              args( ( CHAR_DATA *ch, char *argument ) );
void    do_regeneration       args( ( CHAR_DATA *ch, char *argument ) );
void    do_bite               args( ( CHAR_DATA *ch, char *argument ) );
void    do_tailwhip           args( ( CHAR_DATA *ch, char *argument ) );
void    do_bloodlust          args( ( CHAR_DATA *ch, char *argument ) );
void    do_fade               args( ( CHAR_DATA *ch, char *argument ) );
void    do_flank              args( ( CHAR_DATA *ch, char *argument ) );
void    do_darkness           args( ( CHAR_DATA *ch, char *argument ) );
void    do_goblinmob          args( ( CHAR_DATA *ch, char *argument ) );
void    do_chant              args( ( CHAR_DATA *ch, char *argument ) );
void    do_warcry             args( ( CHAR_DATA *ch, char *argument ) );

/* wizutil.c */
char *  area_name             args( ( AREA_DATA *pArea ) );
void    do_exlist             args( ( CHAR_DATA *ch, char *argument ) );
void    do_vlist              args( ( CHAR_DATA *ch, char *argument ) );
void    do_rename             args( ( CHAR_DATA *ch, char *argument ) );
void    do_for                args( ( CHAR_DATA *ch, char *argument ) );
...
/* Fallen Angels drink system */
bool auto_quaff args((CHAR_DATA *ch, OBJ_DATA *obj));

/* Weather system function declarations */
void weather_update args((void));
void lightning args((void));
void init_weather args((void));
int calc_season args((void));
void update_daylight args((char buf[SECT_MAX][MAX_STRING_LENGTH]));

/* Keyring system function declarations */
